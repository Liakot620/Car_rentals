                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item"><a href="{{ route('cars.create')}}"class="btn btn-md btn-success me-3">Create</a></li>
                            </ol>
                        </div>
                    </div> <!--end::Row-->
                </div> <!--end::Container-->
        ...
        <thead class="table-dark">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                    @if($car->image)
                        <img src="{{ asset('storage/' . $car->image) }}" alt="Car Image" width="60">
                    @else
                        N/A
                    @endif
                </td>
                <td>
                    ...
                    <a href="{{ route('cars.show', $car->id) }}" class="btn btn-sm btn-info">show</a>
