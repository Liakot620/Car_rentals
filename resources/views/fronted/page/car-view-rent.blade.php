                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-12">
                                <div class="new-cars-txt">
                                    ...
                                    <h2 class="new-cars-para2" > Daily Rent : BDT: {{$car_details->daily_rent_price}}</h2>                               
                                </div>
                                ...
                                <form action="{{ url('/submitRent',$car_details->id) }}" method="POST">
                                    ...
                                    <button type="submit" style="margin-left: 30%" class="btn btn-primary btn-lg">Book Now</button>
                                </form>
